...
```{r}
power_consumption <- "~/Archives/Máster GeoTech/4. Master thesis/IoT-Modelling/data/processed_data/power_consumption_processed.csv" |> read.csv()

sensors <- "~/Archives/Máster GeoTech/4. Master thesis/IoT-Modelling/data/processed_data/sensors_processed.csv" |> read.csv()
```
...
```{r}
sensors_sf <- "~/Archives/Máster GeoTech/4. Master thesis/IoT-Modelling/data/processed_data/sensors_processed.csv" |> read.csv() |> create_sf_from_df()
```
