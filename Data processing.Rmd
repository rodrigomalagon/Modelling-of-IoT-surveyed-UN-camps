...
```{r}
power_consumption <- read.csv(file = 'C:/Program Files/PostgreSQL/my_SQL_data/Master thesis SQL data/query_outputs/abyei_l2_ts_values_pow_con.csv')
sensors <- read.csv(file = 'C:/Program Files/PostgreSQL/my_SQL_data/Master thesis SQL data/query_outputs/abyei_l2_sensors_pow_con.csv')
```
